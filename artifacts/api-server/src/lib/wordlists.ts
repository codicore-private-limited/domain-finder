...
/** Curated high-value action verbs for the HUNT_POOL sweep (original quality set).
 *  Kept small intentionally — quality over quantity. The LLM generates additional
 *  premium names through the domain-suggester pipeline. */
...
/** Curated high-value tech/business nouns (original quality set). */
const VN_TECH_NOUNS = [
